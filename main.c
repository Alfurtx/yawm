...
setupnetcheck(void)
{
    ...
    XChangeProperty(display, root.window, netatoms[NET_WM_CHECK], XA_WINDOW, 32, PropModeReplace,
                    (unsigned char*) &checkwin, 1);
    XChangeProperty(display, root.window, netatoms[NET_WM_SUPPORTED], XA_ATOM, 32, PropModeReplace,
